...
public class Initializer {
    ...
    public void init() {
        ...
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 4);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 5);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 6);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 7);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 8);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 9);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 10);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 11);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 12);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 13);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 14);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 15);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 16);");
        jdbcTemplate.execute("insert into option_task(option, task) values (1, 17);");
