...
public class MVCController {
    ...
    public ModelAndView modulePage(@PathVariable Integer id, Model model) throws NoSuchModuleInDB, NoSuchUserInDB {
        model.addAttribute("role", userInformation.getUserRole().name());
        model.addAttribute("moduleId", id);
        model.addAttribute("moduleCapacity", manager.getModuleCapacity(manager.getModuleById(id)));
        model.addAttribute("miro_board", userInformation.getUser().getMiroBoard());
    ...
    @HandleDataActionExceptions
    public String autogeneratedOption(Model model) throws NoSuchUserInDB {
        model.addAttribute("miro_board", userInformation.getUser().getMiroBoard());
        model.addAttribute("role", userInformation.getUserRole().name());
    ...
    @HandleDataActionExceptions
    public String homework(Model model, @PathVariable Integer id) throws NoSuchHomeworkException, NoSuchUserInDB {
        model.addAttribute("role", userInformation.getUserRole().name());
